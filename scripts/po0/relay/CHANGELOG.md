...
## 2026.09.06+build.1 访问设备客户端界面与通道管理
...
- 本次使用 `po0-scripts-v2026.09.06.1` 独立发布五个主脚本；manager / LAN Worker 仅同步发布版本，本次不构建 APK。同步删除旧 WAN probe 的源码、包定义、桌面入口与构建 / 发布清单，修正文档残留；五个发布脚本版本统一。
