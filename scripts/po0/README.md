...
这个目录保存 PO0 或类似中转机的部署与维护工具。这里仅提供子系统导航；部署命令、菜单、官方账号、上报间隔、状态文件、客户端配置和定时任务以对应模块 README 为准。

## 模块入口

| 目标 | 用户主文档 | 说明 |
| --- | --- | --- |
| 管理转发、LAN 更新镜像与七端官方上报 | [`relay/README.md`](./relay/README.md) | PO0 中转系统的主入口；客户端入口、发布渠道、版本历史和实现文档均从这里继续进入。 |
