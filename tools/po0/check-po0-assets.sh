...
expected_po0_version="${PO0_EXPECTED_ASSET_VERSION:-2026.08.30+build.3}"
expected_po0_release_date="${PO0_EXPECTED_RELEASE_DATE:-2026-08-30}"
expected_po0_release_tag="${PO0_EXPECTED_RELEASE_TAG:-po0-v2026.08.30.3}"
