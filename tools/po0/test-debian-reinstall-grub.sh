...
[[ "${SCRIPT_VERSION}" == "2026.07.22+build.1" ]] || fail "unexpected reinstall script version"
...
[[ "${version_output}" == *'version=2026.07.22+build.1'* ]] || fail "reinstall --version lacks current version"
