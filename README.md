...
本轮脚本版本为 `2026.09.05+build.2`，tag 为 `po0-v2026.09.05.2`；outbound APK 为 `2026.09.05-r1`，WAN probe APK 继续为 `2026.08.30-r5`。旧版 raw 可执行入口已禁用；Egern、Stash、Loon 和未纳入 Release 的独立工具仍按各自文档使用允许的 raw 路径。
